...
internal extension _EasyHandle {
    func completedTransfer(withErrorCode errorCode: Int?, errorDescription: String?) {
        delegate?.transferCompleted(withErrorCode: errorCode, errorDescription: errorDescription)
    }
}
